(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('underscore'), require('tibetan-normalizer'), require('tibetan-syllable-parser')) :
  typeof define === 'function' && define.amd ? define(['exports', 'underscore', 'tibetan-normalizer', 'tibetan-syllable-parser'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.TibetanToPhonetics = {}, global._, global.TibetanNormalizer, global.tibetanSyllableParser));
})(this, (function (exports, _, TibetanNormalizer, tibetanSyllableParser) { 'use strict';
  ...
  var Syllable = function(syllable) {
    var parsed = new tibetanSyllableParser.TibetanSyllableParser(syllable).parse();
