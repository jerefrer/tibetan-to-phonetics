...
const TibetanSyllableParser = function(syllable, options = {}) {
  ...
  return {
    ...
    at: function(element, delta, options = {}) {
      ...
      if (options.fromEnd) index = _$1(syllable).lastIndexOf(element);
      else                 index = _$1(syllable).indexOf(element);
    ...
    parse: function() {
      ...
      if (this.length() == 1) this.root = _$1(this.simplifiedSyllable()).first();
      ...
      if (!this.root) {
        if (this.length() == 2) {
          ...
          if (!(_$1(this.syllable).last() == 'ས')) this.root = this.syllable[1];
...
export { Exceptions, Settings, TibetanTransliterator, baseRules, defaultSettings, removeUntranscribedPunctuationAndNormalize, syllablesWithUnknownConsonant };
