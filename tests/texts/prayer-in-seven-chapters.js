...
runTestGroup({
  ...
  tests: [
    ...
    { tibetan: 'བཛྲ་སྤྲོས་བྲལ་ཆོས་དབྱིངས་ཀ་དག་མཁར། །', converted : "vajra trötral chöying katak khar" },
    { tibetan: 'གུ་རུ་བདེ་ཆེན་ཁུར་ལྕི་ཐོད་ཕྲེང་ལྔ། །', converted : "guru déchen khurchi thötr'eng nga" },
    { tibetan: 'པདྨ་སྐྱོན་བྲལ་རང་བྱུང་སངས་རྒྱས་གཉིས། །', converted : "padma kyöntral rangchung sang-gyé nyi" },
    ...
    // Chapter 2
    { tibetan: 'ༀ་ནི་རྒྱལ་བ་དགོངས་བརྒྱུད་ཀུན་ཏུ་བཟང་། །', converted: "om ni gyalwa gong-gyü küntu zang" },
    ...
    { tibetan: 'བརྒྱུད་གསུམ་དཔལ་ཡོན་བླ་མར་གསོལ་བ་འདེབས། །', converted: "gyüsum palyön lamar sölwa dep" },
    ...
    // Chapter 3
    { tibetan: 'ༀ་ནི་གཏིང་གསལ་གཞོན་ནུ་བུམ་པའི་དབྱིངས། །',  converted: "om ni tingsal zhön-nu pumpé ying" },
    ...
    { tibetan: 'བཛྲ་དབྱིངས་ཀྱི་གཞལ་ཡས་ཁང་ཆེན་པོར། །',  converted: "vajra yingkyi zhalyé khangchen por" },
    ...
    { tibetan: 'བར་ཆད་མེད་པ་ཞལ་མཐོང་ལུང་བསྟན་ནས། །',  converted: "parché mépa zhalthong lungten né" },
    ...
    { tibetan: 'རྒྱལ་ཀུན་ཡེ་ཤེས་གཅིག་བསྡུས་གསོལ་བ་འདེབས། །', converted: "gyalkün yéshé chikdü sölwa dep" },
    ...
    { tibetan: 'སྙིགས་མའི་རྒུད་ཞི་ཕན་བདེའི་དཔལ་སྤྱོད་པའི། །', converted: "nyikmé güzhi p'endé palchö pé" },
    ...
    { tibetan: 'ཧཱུྃ་ཞེས་མཁྱེན་བརྩེ་ནུས་པའི་རྩལ་ལྡན་ཐུགས། །', converted: "hung zhé khyentsé nüpé tsalden thuk" },
    ...
    { tibetan: 'པདྨ་ལས་འཁྲུངས་སྐྱོན་བྲལ་ཡོན་ཏན་རྫོགས། །', converted: "padma létr'ung kyöntral yönten dzok" },
    ...
    { tibetan: 'གཉིས་སུ་མེད་པའི་སྐལ་བཟང་བདག་སྦྱར་ལ། །', converted: "nyisu mépé kalzang dajar la" },
    ...
    { tibetan: 'ཧཱུྃ་གི་སྣང་སྲིད་ཟིལ་གནོན་བདེ་ཆེན་རྒྱལ། །', converted: "hung ki nangsi silnön déchen gyal" },
    ...
    { tibetan: 'པདྨ་རྒྱལ་པོ་བཅུ་གསུམ་སྙིང་ནས་དྲན། །', converted: "padma gyalpo chusum nying-né tren" },
