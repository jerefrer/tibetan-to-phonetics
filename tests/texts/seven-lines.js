...
runTestGroup({
  ...
  tests: [
    ...
    { tibetan: 'ཡ་མཚན་མཆོག་གི་དངོས་གྲུབ་བཪྙེས༔', transliteration: "yamtsen chok-ki ngötrup nyé" },
    { tibetan: 'པདྨ་འབྱུང་གནས་ཞེས་སུ་གྲགས༔', transliteration: "padma jung-né zhésu trak" },
