...
runTestGroup({
  ...
  tests: [
    ...
    { tibetan: 'སྔོན་ཚེ་རིག་འཛིན་ནུས་ལྡན་རྡོ་རྗེ་རྩལ། །', converted: "ngöntsé rikdzin nüden dorjé tsel" },
    { tibetan: 'མ་འོངས་བདེ་གཤེགས་མོས་པ་མཐའ་ཡས་ཞབས། །', converted: "ma-ong déshek möpa thayé zhap" },
    { tibetan: 'ད་ལྟ་པད་འབྱུང་རྒྱལ་ཚབ་འདྲོག་བན་དངོས། །', converted: "tata péjung gyeltsap drokpen ngö" },
    { tibetan: 'འཇིགས་བྲལ་ཡེ་ཤེས་རྡོ་རྗེར་གསོལ་བ་འདེབས། །', converted: "jiktrel yéshé dorjer sölwa dep" },
    { tibetan: 'སངས་རྒྱས་ཀུན་གྱི་མཁྱེ༵ན་གཉིས་ཡེ་ཤེས་གཟུགས། །', converted: "sang-gyé künkyi khyen-nyi yéshé zuk" },
    { tibetan: 'བརྩེ༵་ཆེན་ཡེ་ཤེས་རྣམ་རོལ་འཇམ་དཔལ་དབྱངས། །', converted: "tséchen yéshé namröl jampel yang" },
    ...
    { tibetan: 'ང༵ག་དབ༵ང་སྲས་བཅས་རྒྱལ་ཀུན་དགྱེས་པའི་ལམ། །', converted: "ngakwang séché gyelkün gyépé lam" },
    ...
    { tibetan: 'དགེ༵་ལེ༵གས་དཔ༵ལ་འབ༵ར་ཞབས་ལ་གསོལ་བ་འདེབས། །', converted: "gélek pelbar zhapla sölwa dep" },
