...
runTestGroup({
  ...
  tests: [
    ...
    { tibetan: 'དཁྱ',  transliteration: 'khya'},
    ...
    { tibetan: 'དབླ',  transliteration: 'la'},
    { tibetan: 'དརླ',  transliteration: 'la'},
    { tibetan: 'དསླ',  transliteration: 'la'},
    { tibetan: 'དཟླ',  transliteration: 'da'},
