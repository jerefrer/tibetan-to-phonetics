...
runTestGroup({
  ...
  tests: [
    ...
    { tibetan: 'ཀུན་གྱི་རྩེ་མོ་འོད་གསལ་མཆོག་མི་འགྱུར། ', converted: "künkyi tsémo ösel chokmin gyur", pending: true },
    ...
    { tibetan: 'ཡངས་སོ་ཆེའོ་མཁའ་མཉམ་རྒྱལ་བའི་ཐུགས།', converted: "yangso ché-o kha-nyam gyelwé thuk" },
  ]
})
