...
runTestGroup({
  ...
  tests: [
    { tibetan: 'སངས་རྒྱས་དང་། །ཆོས།',  transliteration: 'sang-gyé tang chö' },
    ...
    { tibetan: 'ཀུན་གྱི་རྩེ་མོ་འོད་གསལ་མཆོག་མི་འགྱུར། ', transliteration: "künkyi tsémo ösel chokmin gyur", pending: true },
